"""
speciesmap.org — GBIF sync worker — Amphibia
Runs as a Coolify scheduled task — Sunday 6am UTC
Fetches Amphibia sightings from GBIF for North America.
"""
...
def main():
    print("=" * 50)
    print(f"  speciesmap.org — GBIF sync: Amphibia")
    ...
    try:
        while True:
            print(f"\n  Fetching Amphibia offset {offset}...")

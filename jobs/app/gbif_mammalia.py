"""
speciesmap.org — GBIF sync worker — Mammalia
Runs as a Coolify scheduled task — Sunday 3am UTC
Fetches Mammalia sightings from GBIF for North America.
"""
...
def main():
    print("=" * 50)
    print(f"  speciesmap.org — GBIF sync: Mammalia")
    ...
    try:
        while True:
            print(f"\n  Fetching Mammalia offset {offset}...")

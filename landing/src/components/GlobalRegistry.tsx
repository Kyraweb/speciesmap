...
export function GlobalRegistry() {
  ...
  const [openMobileRegionId, setOpenMobileRegionId] = useState<string | null>(null);
  ...
  const toggleMobileRegion = (id: string) => {
    setOpenMobileRegionId((prev) => (prev === id ? null : id));
  };
  ...
  return (
    <section id="registry" className="py-24 md:py-32 bg-surface-container-low overflow-hidden scroll-mt-24">
      <div className="max-w-screen-2xl mx-auto px-6 md:px-8 space-y-14 md:space-y-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-14 lg:gap-20 items-start">
          <div className="lg:col-span-5 space-y-10 md:space-y-12">
            <div className="space-y-6">
              ...
              <motion.h2
                ...
                viewport={{ once: true }}
                className="text-4xl md:text-5xl lg:text-6xl font-headline font-bold text-on-surface leading-tight"
              >
              ...
              <motion.p
                ...
                className="text-on-surface-variant font-body text-base md:text-lg leading-relaxed max-w-lg"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 md:gap-6 pt-8 border-t border-outline-variant/20">
            ...
            >
              ...
              <p className="text-sm text-on-surface-variant leading-relaxed">
                This view remains connected to live global and regional activity, ensuring it reflects the
                platform as it exists now rather than a fixed snapshot in time.
              </p>
            </motion.div>
          </div>
          ...
          <div className="lg:col-span-7 relative">
            ...
            <div className="md:hidden space-y-3">
              <div className="bg-surface border border-outline-variant/10 rounded-sm overflow-hidden editorial-shadow">
                <div className="p-6 border-b border-outline-variant/10 bg-surface-container-lowest">
                  ...
                  <p className="text-[10px] font-bold uppercase tracking-widest text-on-surface-variant/60">
                    Tap a region to open its live platform entry
                  </p>
                </div>

                <div className="p-3">
                  {regions.map((region) => {
                    const isOpen = openMobileRegionId === region.id;

                    return (
                      <div
                        key={region.id}
                        className="border border-outline-variant/12 bg-surface rounded-sm overflow-hidden mb-3 last:mb-0"
                      >
                        <button
                          onClick={() => toggleMobileRegion(region.id)}
                          className={`w-full px-4 py-4 text-left flex items-center justify-between gap-4 transition-colors ${
                            isOpen ? 'bg-primary/[0.05]' : 'bg-transparent'
                          }`}
                        >
                          <div className="min-w-0">
                            <div className="text-[9px] font-bold uppercase tracking-widest text-on-surface-variant/50">
                              {region.id} / region
                            </div>
                          ...
                          <div className="flex items-center gap-3 shrink-0">
                            <div className="text-right">
                              <div className="text-[10px] font-mono text-on-surface-variant/45">
                        ...
                        <AnimatePresence initial={false}>
                          {isOpen && (
                            ...
                            >
                              <div className="px-4 pb-5 pt-1 space-y-5 border-t border-outline-variant/10">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                  <div className="space-y-2">
                                    ...
                                    <div className="text-2xl font-headline text-on-surface">
                                      <CountUp value={region.sightings} />
                                    </div>
                                  </div>
                                  ...
                                  <div className="space-y-2">
                                    ...
                                    <div className="text-2xl font-headline text-on-surface">
                                      <CountUp value={region.activeSensors} />
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div className="space-y-2">
                                  ...
                                  <div className="text-[11px] font-mono text-secondary">{region.coordinates}</div>
                                </div>
                                ...
                                <a
                                  ...
                                  className="inline-flex items-center gap-3 bg-primary text-on-primary px-6 py-3 text-[10px] font-bold uppercase tracking-[0.24em] hover:bg-primary-container transition-all editorial-shadow"
                                >
                                  Open regional map
            ...
            {/* DESKTOP ATLAS */}
            <div className="hidden md:flex bg-surface border border-outline-variant/10 rounded-sm overflow-hidden editorial-shadow min-h-[600px] flex-col">
